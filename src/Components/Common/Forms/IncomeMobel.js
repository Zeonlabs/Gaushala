      ...
      <div>
        ...
        >
          ...
          <Form className="form-income" onSubmit={this.handleSubmit}>
            <div className="row">
              ...
              >
                {getFieldDecorator("incometype", {
                  ...
                  <Select className="in-icon-arrow" placeholder="Aavk no p/kar ps>d kro">
                    ...
                    <Option value="qatr nI Aavk">
                    qatr nI Aavk
                    </Option>
                    <Option value="pxu nI Aavk">
                    pxu nI Aavk
                    </Option>
                    <Option value=" ANy Aavk">
                      ANy Aavk
                    </Option>
                    <Option value="data7I nI Aavk">
                    data7I nI Aavk
                    </Option>
                  </Select>
                )}
            ...
            <div className="row">
              {/* ------------------------------Doner Name-------------------------------- */}
              <Form.Item className="ant-col ant-col-14" label={`${type === "expense" ? "nam" : "data 7I"}`}>
            ...
            <div className="row">
              {/* ------------------------------Income in --------------------------------- */}
              <Form.Item label={`${type === "expense" ? "cukv~aI" : "dan SvIkar"}`}>
